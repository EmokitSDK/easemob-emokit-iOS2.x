...
#warning EmoKit Add
        self.emoLabel.frame = CGRectMake(CGRectGetMinX(_bubbleView.frame) - 10 - 30, CGRectGetMinY(_bubbleView.frame) - 7, 30, SEND_STATUS_SIZE);
    }
    else{
...
#warning EmoKit Add
        self.emoLabel.frame = CGRectMake(CGRectGetMaxX(_bubbleView.frame) + 10, CGRectGetMinY(_bubbleView.frame) - 7, 30, SEND_STATUS_SIZE);
    }
}
